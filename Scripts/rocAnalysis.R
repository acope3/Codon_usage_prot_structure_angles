...
parser$add_argument("--mixture_definition",type="character",default="allUnique")
...
parser$add_argument("--development",type="character",help="Run a developmental version of AnaCoDa",default="~/R/")
...
mixDef <- args$mixture_definition
